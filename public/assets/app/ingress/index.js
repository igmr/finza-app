...
const btnInfo = async (id) => {
    window.location.href = `${baseUrlIngress}/${id}`;
    return;
};

const buildList = async () => {
    let content = buildHeader();
    const response = await getAllIngress();
...
const buildHeader = () => {
    ...
    <div class="nk-tb-item nk-tb-head">
        ...
        <div class="nk-tb-col tb-col-md">
            <span class="sub-text">Classification</span>
        </div>
        <div class="nk-tb-col">
...
const buildItem = (data) => {
    ...
    return `
            <div class="nk-tb-item" onclick="btnInfo(${data.ing_id})">
                <div class="nk-tb-col">
                    <span>${data.ing_id}</span>
                </div>
                <div class="nk-tb-col tb-col-md">
