        ...
        <div @class(['nk-block-head', 'nk-block-head-md'])>
            <form>
                ...
                <div @class(['nk-block-between'])>
                    ...
                    <div @class(['nk-block-head-content'])>
                        <a href="{{ route('app.bank.index') }}" @class(['btn', 'btn-sm', 'btn-dim', 'btn-secondary'])>
                            ...
                            <div @class(['row', 'gy-4'])>
                                <div @class(['col-sm-6'])>
                                    <div @class(['form-group'])>
                                        <label @class(['form-label']) for="abbreviature">Abbreviature</label>
                                        <div @class(['form-control-wrap'])>
                                            <div @class(['form-icon form-icon-left'])>
                                                <em @class(['icon', 'ni', 'ni-code-download'])></em>
                                            </div>
                                            <input type="text" @class(['form-control']) id="abbreviature"
                                                placeholder="Bank-0001" name="abbreviature">
                                        </div>
                                    </div>
                                </div>
                                <div @class(['col-sm-6'])>
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control']) id="name"
                                                placeholder="Bank-0001" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div @class(['col-sm-12'])>
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <textarea @class(['form-control']) id="observation" placeholder="Observation the bank" name="observation"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
