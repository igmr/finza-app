            ...
            <div @class(['nk-block-between'])>
                ...
                <div @class(['nk-block-head-content'])>
                    <div @class(['toggle-wrap', 'nk-block-tools-toggle'])>
                        <a href="{{ route('app.egress.index') }}" @class(['btn', 'btn-sm', 'btn-dim', 'btn-secondary'])>
                        ...
                        <div @class(['card-inner'])>
                                    ...
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control']) id="concept"
                                                placeholder="Egress" name="concept">
                                        </div>
                                    </div>
                                </div>
                                <!-- .Concept -->
                            ...
                            <div @class(['form-group'])>
                                ...
                                <div @class(['form-control-wrap'])>
                                    ...
                                    <textarea @class(['form-control']) id="description" placeholder="Description of egress" name="description"></textarea>
                                </div>
                            </div>
                            <!-- .Description -->
                        </div>
                        ...
                        <div @class(['card-inner'])>
                            ...
                            <div @class(['form-group'])>
                                ...
                                <div @class(['form-control-wrap'])>
                                    ...
                                    <textarea @class(['form-control']) id="observation" placeholder="Observation of egress" name="observation"></textarea>
                                </div>
                            </div>
                            <!-- .Observation -->
                        </div>
