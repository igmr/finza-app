        ...
        <div @class(['nk-block-head', 'nk-block-head-md'])>
            <form>
                ...
                <div @class(['nk-block-between'])>
                    ...
                    <div @class(['nk-block-head-content'])>
                        <a href="{{ route('app.saving.index') }}" @class(['btn', 'btn-sm', 'btn-dim', 'btn-secondary'])>
                ...
                <div @class(['card', 'card-preview', 'mt-3'])>
                    <div @class(['card-inner'])>
                        <div class="preview-block">
                            <!-- name - amount - date_finish - observation -->
                                    ...
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control']) id="name"
                                                placeholder="Saving-001" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div @class(['col-sm-4'])>
                                    ...
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control', 'date-picker'])
                                                data-date-format="yyyy-mm-dd" id="date_finish" placeholder="2023-12-31"
                                                name="date_finish">
                                        </div>
                            ...
                            <div @class(['col-sm-12'])>
                                <div @class(['form-group'])>
                                    ...
                                    <div @class(['form-control-wrap'])>
                                        ...
                                        <textarea @class(['form-control']) id="observation" placeholder="Observation the saving" name="observation"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
