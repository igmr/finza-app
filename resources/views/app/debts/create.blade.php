        ...
        <div @class(['nk-block-head', 'nk-block-head-md'])>
            <form>
                ...
                <div @class(['nk-block-between'])>
                    ...
                    <div @class(['nk-block-head-content'])>
                        <a href="{{ route('app.debt.index') }}" @class(['btn', 'btn-sm', 'btn-dim', 'btn-secondary'])>
                ...
                <div @class(['card', 'card-preview', 'mt-3'])>
                    <div @class(['card-inner'])>
                        <div class="preview-block">
                            <!-- category - name - amount - period - day - date_at - file - observation -->
                                ...
                                <div @class(['col-sm-6'])>
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])="">
                                            <select @class(['form-select']) name='category' id='category' data-search="on">
                                            </select>
                                        </div>
                                    </div>
                                </div>
