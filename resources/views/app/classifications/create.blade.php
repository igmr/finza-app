        ...
        <div @class(['nk-block-head', 'nk-block-head-md'])>
            <form>
                ...
                <div @class(['nk-block-between'])>
                    ...
                    <div @class(['nk-block-head-content'])>
                        <a href="{{ route('app.classification.index') }}" @class(['btn', 'btn-sm', 'btn-dim', 'btn-secondary'])>
                                    ...
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control']) id="code"
                                                placeholder="cls-0001" name="code">
                                        </div>
                                    </div>
                                </div>
                                <div @class(['col-sm-6'])>
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <input type="text" @class(['form-control']) id="name"
                                                placeholder="Classification-0001" name="name">
                                        </div>
                                    </div>
                                </div>
                                <div @class(['col-sm-12'])>
                                    <div @class(['form-group'])>
                                        ...
                                        <div @class(['form-control-wrap'])>
                                            ...
                                            <textarea @class(['form-control']) id="observation" placeholder="Observation the classification" name="observation"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
